	...
	<nav class="navbar navbar-light navbar-expand-lg navbar-fixed-top no-bg def-nav">
		<div class="container-fluid">
			...
			{{-- <div class="navbar-header"> --}}
				...
				<a class="navbar-brand logo-white " href="{{ route('welcome') }}"><img src="{{asset('assets/images/apple-touch-icon-152x152.png')}}" alt="logo">Quality Control</a>
				<a class="navbar-brand-2 logo-black" href="{{ route('welcome') }}"><img src="{{asset('assets/images/apple-touch-icon-152x152.png')}}" alt="logo">Quality Control</a>
