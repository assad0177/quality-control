<nav style="background-color:   #fff    " class="container-fluid navbar navbar-top navbar-expand navbar-dashboard navbar-dark ps-0 pe-2 pb-0">
            ...
            <ul class="navbar-nav align-items-center"  >
                <li class="nav-item dropdown ms-lg-3">
                    ...
                    <div class="dropdown-menu dashboard-dropdown dropdown-menu-end mt-2 py-1">
                        ...
                        @if(Illuminate\Support\Str::contains(Route::currentRouteName(),'client'))
                        <a class="dropdown-item d-flex align-items-center" href="{{ route('client.logout') }}" onclick="event.preventDefault();
                        ...
                        @elseif(Illuminate\Support\Str::contains(Route::currentRouteName(),'terminal'))
                        <a class="dropdown-item d-flex align-items-center" href="{{ route('terminal.logout') }}" onclick="event.preventDefault();
                        document.getElementById('logout-form-terminal').submit();">
